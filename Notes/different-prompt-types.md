...
**Sample Triggering words for Open-Ended Prompts:**
        
| Keyword      | Why it is open-ended                      | Example                                            |
| ------------ | ----------------------------------------- | -------------------------------------------------- |
| **Explain**  | Asks for detailed understanding           | “Explain how APIs work.”                           |
| **Describe** | Invites a broad description               | “Describe the benefits of automation testing.”     |
| **Discuss**  | Encourages multiple viewpoints            | “Discuss the pros and cons of remote work.”        |
| **Explore**  | Invites investigation or brainstorming    | “Explore different ways to improve test coverage.” |
| **Analyze**  | Asks for deeper reasoning, not just facts | “Analyze why this test case failed.”               |
